 ...
 * 3) On your menu item, type 'has-form' in the CSS-classes field. Type 'modal-image' in the XFN field
 * 4) Save Menu. Your menu item will now appear as a modal-image in your top-menu
*/
if ( ! function_exists( 'foundationpress_add_menuclass' ) ) {
	function foundationpress_add_menuclass( $ulclass ) {
		$find = array('/<a rel="button"/', '/<a title=".*?" rel="button"/');
		$replace = array('<a rel="modal-image" class="modal-image"', '<a rel="modal-image" class="modal-image"');
