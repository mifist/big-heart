...
// Ban Wordpress updates
//Ban update plugins
//Ban template updates
//define( 'WP_AUTO_UPDATE_CORE', false );
// ограничить количество сохраненных версий для каждого поста
//define('WP_POST_REVISIONS', 2 );
//define('FORCE_SSL_LOGIN', true);
//define('FORCE_SSL_ADMIN', true);
//define('EMPTY_TRASH_DAYS', 2 );
//отключить редактирование файлов тем и плагинов
//define('DISALLOW_FILE_EDIT',true);
// отключить установку новых тем и плагинов, и их обновление:
...
<IfModule mod_deflate.c>
  ...
  AddOutputFilterByType DEFLATE application/javascriptz
